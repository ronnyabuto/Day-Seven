...
import { createMockSuite, expectToBeAccessible } from '@/lib/test-utils'
...
describe('SuiteCard Component', () => {
  ...
  describe('interactions', () => {
    ...
    test('should not call onSelect when unavailable suite is clicked', async () => {
      ...
      const buttons = screen.getAllByText(/unavailable/i)
  ...
  describe('accessibility', () => {
    ...
    test('should have correct ARIA labels for unavailable suites', () => {
      ...
      const card = screen.getAllByRole('button', { name: /unavailable/i })[0]
